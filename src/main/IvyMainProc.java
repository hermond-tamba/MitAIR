 ...
 */
public class IvyMainProc {
	public String[] args;
	public static ResolveReport report;
    private static int HELP_WIDTH = 80;
    
    public IvyMainProc(String par) throws Exception{
    	args = par.split(" ");
    ...
    //-settings PD190_tester.ivysettings.xml -ivy ivy_tester.xml
    ...
    private static void invoke(Ivy ivy, File cache, ModuleDescriptor md, String[] confs,
        ...
        URLClassLoader classLoader = new URLClassLoader((URL[]) urls.toArray(new URL[urls.size()]),
                IvyMainProc.class.getClassLoader());
